...
wget https://raw.githubusercontent.com/neodevpro/resources/master/n8sflash.zip
...
wget -O boot.img https://raw.githubusercontent.com/neodevpro/resources/master/N9500.img
